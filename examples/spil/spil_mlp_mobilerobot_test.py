...
if __name__ == "__main__":
    ...
    evaluator.networks.load_state_dict(torch.load('C:/Users/pengbaiyu/PycharmProjects/spil_share/gops/results/SPIL/0125-161250/apprfunc/apprfunc_2000.pkl'))

    evaluator.render_batch()
